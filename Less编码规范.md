...
[强制]：字体顺序：font-style | font-variant | font-weight | font-size | line-height | font-family
font-style: normal;
...
[强制]：边框顺序：border-width | border-style | border-color
border-width :1px;
border-style: solid;
border-color: #CCC;
...
第二步：webpack.config.js中配置，安装依赖包yarn add stylelint-webpack-plugin
